<header class="header navbar navbar-expand-sm">
    ...
    <ul class="navbar-item flex-row ml-md-auto">
        <li class="nav-item dropdown search-animated">
            <a class="nav-link toggle-search" href="javascript:void(0);">
                <i class="las la-search "></i>
            </a>
        </li>
        <div class="search-form">
            <form class="h-100" action="{{ url('/pages/search-result') }}">
                <i class="las la-search "></i>
                <input class="form-control" placeholder=" {{__('Search here')}}"/>
            </form>
        </div>
        <!-- Using Switch option -->
