                    ...
                    <div class="login-one-start">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="login-one-inputs mt-5">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="{{__('Name')}}" />
                            ...
                            <div class="login-one-inputs mt-3">
                                <input id="email" class="form-control @error('email') is-invalid @enderror" type="email" value="{{ old('email') }}" placeholder="{{__('Email')}}" />
...
>>>>>>> a2b10a1ebc0cc1aa739ccd406e74467aa71388cb
                                @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
...
<<<<<<< HEAD
                            ...
                            <div class="login-one-inputs mt-3">
                                <input id="password" class="form-control @error('password') is-invalid @enderror" type="password" placeholder="{{__('Password')}}" />
                                <i class="las la-lock"></i>
=======
